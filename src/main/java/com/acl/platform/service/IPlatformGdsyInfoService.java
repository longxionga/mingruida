...
/**
 * 
 *className:IPlatformGdsyInfoService
 *author:wangzhe
 *createDate:2016年8月12日 上午10:59:51
 *version:3.0
 *department:安创乐科技
 *description: 模式二service接口
 */

public interface IPlatformGdsyInfoService {
	 ...
	 * @return
	 */
	List<Map<String, Object>> selectGdsyDeptGroup(HashMap<String, Object> paramsMap);
	/**
	 * 查询模式二商品关系
	 * @param paramsMap
	 * @return
