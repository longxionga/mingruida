 ...
 *
 */
public class ParsingShuaBaoMExcelUtil {
...
//        }
    ...
    public  BasicExcelDataEntity getParsingExcelResult2(File file){
        Map<String,String> titleIndex = new HashMap<>();
        Workbook wb = null;
        try {
            wb = WorkbookFactory.create(file);
        ...
        Map<String,String> titleResult = this.readExcelToObjIndex2(wb,0);
        for(String s:titleResult.keySet()){
            System.out.println("表格头的 key : "+s+" value : "+titleResult.get(s).toString());
            String value = titleIndex.get(titleResult.get(s).toString());
            if(value!=null){
        ...
        ArrayList<Map<String,String>> result = this.readExcelToObj2(wb);
        BasicExcelDataEntity excelDataEntity = new BasicExcelDataEntity();
        excelDataEntity.setExcelData(result);
        excelDataEntity.setExcelTitleIndex(titleIndex);
        excelDataEntity.setExcelTitleMap(titleResult);
     ...
     * @param wb
     */
    private Map<String,String> readExcelToObjIndex2( Workbook wb,Integer startReadLine) {
     ...
     * @param wb
     */
    private ArrayList<Map<String,String>> readExcelToObj2( Workbook wb) {
        ArrayList<Map<String,String>> result = null;
         result = readExcel(wb, 0, 1, 0);
        return result;
    }
    ...
    public static void main(String[] args){
        ParsingShuaBaoMExcelUtil excelUtil = new ParsingShuaBaoMExcelUtil();
        //读取excel数据
