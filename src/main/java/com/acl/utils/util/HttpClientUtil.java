...
public class HttpClientUtil {
	...
	//private String proxy_ip = "10.26.98.138";
	public static String proxy_ip = SystemConfig.proxy_ip;

	//private String proxy_port = "3128";
	public static String proxy_port = SystemConfig.proxy_port;
      ...
      connManager.setDefaultMaxPerRoute(400);
		CloseableHttpClient httpclient = HttpClients.custom()
              ...
              //.setProxy(new HttpHost("10.26.98.138", 3128))//设置代理,如果没有关闭 则关闭代理
				.setProxy(new HttpHost(proxy_ip,Integer.valueOf(proxy_port)))//设置代理,如果没有关闭 则关闭代理
              .build();
		List<NameValuePair> nvps = new ArrayList<NameValuePair>();
		for (Map.Entry<String, String> entry : params.entrySet()) {
			nvps.add(new BasicNameValuePair((String) entry.getKey(), (String) entry.getValue()));
