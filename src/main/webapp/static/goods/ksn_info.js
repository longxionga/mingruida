...
dict(1002);
dictInfo(1002,"is_zc");
dictInfo(1002,"is_uses");
dictInfo(1002,"param_is_use");
dictInfo(1002,"prorate_is_use");
						...
						columns : [ [
								...
								},
								{
									...
									formatter : function(value, row, index) {
										if (value == 1)
											...
											return '<span style="color:#f00;">未使用</span>';
									}
								},
								{
									width: 50,
									sortable : false,
									field : 'handout_status',
									title : '分发状态',
									align : 'center',
									//formatter:dictFormatter,
									formatter : function(value, row, index) {
										if (value == 1)
											...
											return '<span style="color:#f00;">未分发</span>';
									}
								},
								{
									width: 100,
                                ...
                                },
								{
									...
									formatter : function(value, row, index) {
										...
										<a class="btns" href="javascript:;" onclick="set(\'' + index + '\');">规格设置</a>\
										<a class="btns" href="javascript:;" onclick="setParam(\'' + index + '\');">参数设置</a>\
									';
										return str;
									}
								} ] ],
