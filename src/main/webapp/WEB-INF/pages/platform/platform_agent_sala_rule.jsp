	...
	<div style="display: none">
		...
		<div class="pt10 pr10 pl10">
					<span class="lay_text_bor">
						<span class="mr10"><a href="javascript:update();" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">新增工资配置</a></span>
	...
	<script type="text/javascript">
        ...
        UE.Editor.prototype.getActionUrl = function(action) {
            ...
            if (action == "uploadimage" || action == "uploadfile") {
                return "../../../../platform/uploadfile?salaRuleId="+ruleId;
            } else {
                return this._bkGetActionUrl.call(this, action);
            }
        }
...
<script type="text/javascript" src='<c:url value="/static/platform/platform_agent_sala_rule.js?v=${applicationScope.v}"></c:url>'></script>
</body>
