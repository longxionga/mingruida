		...
		<div id="toolbar">
			<div class="pt10 pr10 pl10">
				<form id="search" method="post">
				   <span class="lay_text_bor mr10">代理商：<input class="easyui-textbox" style="width:150px;" name="name" data-options="validType:'TextSearch'"/></span>
...
<script type="text/javascript" src='<c:url value="/static/platform/platform_userinfo_dept.js?v=${applicationScope.v}"></c:url>'></script>
