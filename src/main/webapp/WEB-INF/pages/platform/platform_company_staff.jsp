		...
		<div class="pt10 pr10 pl10">
			...
			<%--<span class="lay_text_bor mr10">充值时间：<input class="easyui-datebox" name="start_date" data-options="editable:false,showSeconds:true" style="width:150px;"id="skssj" />&nbsp;-
				...
				<span class="lay_text_bor">
						...
						<span class="mr10"><a href="javascript:update();" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">新增员工信息</a></span>
<%--
...
--%>
	...
	<div id="update" class="easyui-window" title="" style="padding:15px 13px 70px 30px;width:680px;height:480px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,maximizable:!1,closed:!0">
		<form id="updateform" method="post" enctype="multipart/form-data"  autocomplete="off" action-add="insCompanyStaff" action-edit="updCompanyStaff" data-autoform="
			...
			<table class="tables">
				...
				<tr>
					...
					<td>员工身份证姓名：</td>
					<td><input class="easyui-textbox" style="width:150px;"  id="staffname" name="staffname"  data-options="required:true,validType:['ajax[\'staffNameValidate\']','length[1,20]','name']"></td>
				</tr>
				<tr>
					<td>入职时间：</td>
...
<script type="text/javascript" src='<c:url value="/static/platform/platform_company_staff.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>