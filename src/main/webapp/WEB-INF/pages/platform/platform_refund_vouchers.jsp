...
<%--				<span class="lay_text_bor mr10">机具编号：<input class="easyui-textbox" style="width:150px;" name="machine_code"/></span>--%>
				...
				<span class="lay_text_bor">
						...
						<a class="btns" href="javascript:void(0);" onclick="upFiles();">上传充值反券信息</a>
                    	<span class="mr10"><a href="javascript:;" onclick="closeAll();" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-remove'">删除所有充值反券</a></span>
...
<script>
	...
	UE.Editor.prototype.getActionUrl = function(action) {
		...
		if (action == "uploadimage" || action == "uploadfile") {
			return "../../../../platform/refunduploadfile";
		} else {
			return this._bkGetActionUrl.call(this, action);
		}
	}
...
<script type="text/javascript" src='<c:url value="/static/platform/platform_refund_vouchers.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>