...
<body>
	...
	<div style="display: none">
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action-add="insGoodsParam" action-edit="updGoodsParam" data-autoform="
				...
				">
				  <table class="tables">
				  	<tr>
				  		<td>商品名称：</td>
						<td><input class="easyui-combobox" id="goods_id" name="goods_id" style="width:450px;" data-options="required:true"></input></td>
				  	</tr>
				  
				  	<tr>																						 
				  		<td>参数名称：</td>
				  		<td><input class="easyui-textbox" style="width:150px;"  id="param_name" name="param_name"  data-options="required:true,validType:['paramName[\'paramValidate\']','length[2,25]']"></td>
				  		
				  	    <td>参数值：</td>
						<td><input class="easyui-textbox" style="width:150px;" id="param_value" name="param_value" data-options="required:true"></td>
				  	</tr>
...
<script type="text/javascript" src='<c:url value="/static/goods/goods_param.js"></c:url>'></script>
</body>
</html>