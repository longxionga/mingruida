...
<body>
	...
	<div style="display: none">
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,maximizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action-add="insGoodsImage" action-edit="updGoodsImage" data-autoform="
				...
				">
				  <table class="tables">
				  	<tr>
				  	    ...
				  	    <td>图片类型：</td>
						<td><input class="easyui-combobox" style="width:150px;" id=img_type name="img_type" data-options="required:true"></td>
				  	</tr>

					<tr>

						<td>排序</td>
						<td><input class='easyui-textbox' style="width: 150px;" data-options="validType:'int'" id="img_seq" name="img_seq">
						</td>
						<td>图片：</td>
						<td class="tables_td_pos"><input class="easyui-textbox" style="width: 150px;" id="img_uri" name="img_uri" readonly="true" data-options="required:true"> 
      ...
      //  _editor.setDisabled();
        ...
        _editor.addListener('beforeInsertImage', function (t, arg) {
           ...
           // $("#picture").attr("value", arg[0].src);
            ...
            $("#img_uri").textbox('setValue',urlImg);
...
//弹出图片上传的对话框
function upImage() {
	var floder=$('#goods_id').combobox('getValue');
...
<script type="text/javascript" src='<c:url value="/static/goods/goods_image.js"></c:url>'></script>
</body>
</html>