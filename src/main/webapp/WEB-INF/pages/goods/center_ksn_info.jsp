	...
	<div id="toolbar">
		...
		<div class="pt10 pr10 pl10">
			<form id="search" method="post">
				...
				<span class="lay_text_bor mr10">机具名称：<input class="easyui-textbox" style="width:150px;" name="machine_name"/></span>
...
<script type="text/javascript" src='<c:url value="/static/goods/center_ksn_info.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>