...
<body>
	...
	<div style="display: none">
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action-add="insGoodsProrate" action-edit="updGoodsProrate" data-autoform="
				...
				">
				  <table class="tables">
				  	<tr>
				  		<td>商品名称：</td>
						<td><input class="easyui-combobox" id='goods_id' name='goods_id'  data-options="required:true,validType:['prorateName[\'prorateValidate\']']"></input></td>
...
<script type="text/javascript" src='<c:url value="/static/goods/goods_prorate.js"></c:url>'></script>
</body>
</html>