...
<body>
	...
	<div style="display: none">
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action-add="insGoodsSpec" action-edit="updGoodsSpec" data-autoform="
				  ...
				  <table class="tables">
				  	...
				  	<tr>
						...
						<td><input class="easyui-combobox" id='is_use' name='is_use' data-options="required:true"></input></td>
				  		<td>规格名称：</td>
				  		<td><input class="easyui-textbox" style="width:150px;"  id="spec_name" name="spec_name"  data-options="required:true,validType:['specName[\'specValidate\']','length[1,25]']"></td>
...
<script type="text/javascript" src='<c:url value="/static/goods/goods_spec.js"></c:url>'></script>
</body>
</html>