	...
	<div id="toolbar">
		...
		<div class="pt10 pr10 pl10">
			<form id="search" method="post">
				...
				<span class="lay_text_bor mr10">是否包含下级：<input  class="easyui-combobox" id="bufstate" name="bufstate" style="width:150px;" /></span>
...
<script>
	...
	$(function() {
		...
		loadData({start_date:skssj,end_date:sjssj,bufstate:"2"});//初始化加载数据
	});
...
<script type="text/javascript" src='<c:url value="/static/report/report_manege_transaction.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>