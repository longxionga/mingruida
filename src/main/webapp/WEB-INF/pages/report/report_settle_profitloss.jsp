...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				<span class="lay_text_bor mr20">服务商名：<input class="easyui-textbox" style="width:150px;" name="settle_name"  data-options="validType:'length[1,20]'"/></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_settle_profitloss.js?v=${applicationScope.v}"></c:url>'></script>
