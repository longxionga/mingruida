...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				<span class="lay_text_bor mr20">用户名：<input class="easyui-textbox" style="width:150px;" id="user_name" name="user_name"  data-options="validType:'length[1,50]'"/></span>
				<span class="lay_text_bor mr20">电话：<input  class="easyui-textbox" style="width:150px;" id="mobile" name="mobile"  data-options="validType:['int','length[1,11]']"/></span>
				...
				<span class="lay_text_bor mr20">提现状态：<input class="easyui-combobox" id="status" name='status' style="width:60px;" data-options="valueField:'id',textField:'text'" /></span>
				<span class="lay_text_bor mr20">提现类型：<input class="easyui-combobox" style="width:150px;" id="pay_method" name="pay_method"/></span>
				<span class="lay_text_bor mr10">时间选择：<input class="easyui-datetimebox" name="begindate" data-options="editable:false,showSeconds:true" style="width:180px;" id="skssj" />&nbsp;-
				...
				<span class="lay_text_bor">
					...
					<span class="mr10"><a href="#" onclick='expWithdrawalsInfo();' class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-redo'">导出报表</a></span>
					</c:if>
					<!-- 查询按钮放最前，刷新按钮放最后 -->
				</span>
				</form>
...
<script type="text/javascript" src='<c:url value="/static/report/report_withdrawal_info.js?v=${applicationScope.v}"></c:url>'></script>
