...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				<span class="lay_text_bor mr20">用户名：<input class="easyui-textbox" style="width:150px;" name="user_name"  data-options="validType:'length[1,20]'"/></span>
				...
				<span class="lay_text_bor mr20">充值类型：<input class="easyui-combobox" style="width:150px;" id="cz_type" name="cz_type"/></span>
				<span class="lay_text_bor mr20">充值状态：<input class="easyui-combobox" id="cz_state" name='cz_state' style="width:100px;" data-options="valueField:'id',textField:'text'" /></span>			
				...
				<span class="lay_text_bor mr20">充值入口：<input class="easyui-combobox" id="entrance" name='entrance' style="width:100px;" data-options="valueField:'id',textField:'text'" /></span>	
				<span class="lay_text_bor mr20">订单号：<input class="easyui-textbox" style="width:150px;" name="order_id"  data-options="validType:'length[1,50]'"/></span>										
...
<script type="text/javascript" src='<c:url value="/static/report/report_recharge_acc_info.js?v=${applicationScope.v}"></c:url>'></script>
