...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				<span class="lay_text_bor mr20">代理商名称：<input class="easyui-textbox" style="width:150px;" id="broker_name" name="broker_name"/></span>
			    ...
			    <span class="lay_text_bor mr20">代理商手机：<input class="easyui-textbox" style="width:150px;" id="broker_mobile" name="broker_mobile"/></span>		
...
<script>
    $(function() {
        ...
        $("#start_date").datebox("setValue", strDate);
        $("#end_date").datebox("setValue", strendDate);
    });
</script>
...
<script type="text/javascript" src='<c:url value="/static/report/report_broker_day.js?v=${applicationScope.v}"></c:url>'></script>
