...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr20">流水类型：<input class="easyui-combobox" id="purpose" name='purpose' style="width:150px;" data-options="valueField:'id',textField:'text'" /></span>
				<span class="lay_text_bor mr10">时间选择：<input class="easyui-datetimebox" name="start_date" data-options="editable:false,showSeconds:true" style="width:180px;"id="skssj" />&nbsp;-
				<input class="easyui-datetimebox" name="end_date" data-options="editable:false,showSeconds:true" style="width:180px;" id="sjssj"/></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_user_profitloss.js?v=${applicationScope.v}"></c:url>'></script>
