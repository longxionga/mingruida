...
<%--				<span class="lay_text_bor mr20">员工名称：<input class="easyui-textbox" style="width:150px;" name="staffname"/></span>--%>
				...
				<%--<br/>
				<span  class="lay_text_bor mr10">月份选择:
...
<script>
	$(function() {
		...
		$('#brand_id').combobox("setValue","10");
		loadData({position:"-1"});//初始化加载数据
...
<script type="text/javascript" src='<c:url value="/static/report/report_total_standard_achievement.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>