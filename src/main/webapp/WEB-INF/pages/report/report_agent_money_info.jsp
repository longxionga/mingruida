...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr20">代理商名：<input  class="easyui-textbox" style="width:150px;" name="dept_name" /></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_agent_money_info.js?v=${applicationScope.v}"></c:url>'></script>
