...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr20">电话：<input  class="easyui-textbox" style="width:150px;" name="user_mobile"  data-options="validType:['int','length[1,11]']"/></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_user_warning.js?v=${applicationScope.v}"></c:url>'></script>
