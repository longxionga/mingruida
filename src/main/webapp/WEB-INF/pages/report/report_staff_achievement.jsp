	...
	<div id="toolbar">
		...
		<div class="pt10 pr10 pl10">
			<form id="search" method="post">
				...
				<span class="lay_text_bor mr20">所属分公司：<input class="easyui-combobox" id="company_id" name="company" style="width:150px;" /></span>
...
<script>
	$(function() {
      ...
      var date = 	$('#begindate').datebox('getValue');
		loadData({brindnameid:'6',position:'2',begindate:date});//初始化加载数据
...
<script type="text/javascript" src='<c:url value="/static/report/report_staff_achievement.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>