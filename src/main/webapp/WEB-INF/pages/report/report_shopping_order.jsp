...
<body>
	...
	<div style="display: none">
		...
		<div id="toolbar">
			<div class="pt10 pr10 pl10">
				<form id="search" method="post">
				   ...
				   <span class="lay_text_bor mr20">订单状态：<input class="easyui-combobox" style="width:150px;" id="status" name="status"/></span>
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;height:289px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,maximizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action-add="setTrackingNumber" action-edit="setTrackingNumber" data-autoform="
				  ...
				  <table class="tables">
					<tr>
						...
						<td><input class="easyui-textbox" style="width: 150px;"
							...
							data-options="required:true,validType:['length[2,19]']"></td>
						<td>快递单号：</td>
						<td><input class="easyui-textbox" style="width: 150px;"
					...
					<input  type="hidden" value="" id="shopping_order_id" name="shopping_order_id" />
					<tr>
...
<script type="text/javascript" src='<c:url value="/static/report/report_shopping_order.js?v=${applicationScope.v}"></c:url>'></script>
</body>
</html>