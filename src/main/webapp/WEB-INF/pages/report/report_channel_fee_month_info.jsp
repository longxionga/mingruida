...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">
				...
				<span  class="lay_text_bor mr10">日期选择:<input editable="false" class="easyui-datebox" data-options="require:true" type="text" name="begindate" id="begindate"  style="width:100px;"></input></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_channel_fee_month_info.js?v=${applicationScope.v}"></c:url>'></script>
