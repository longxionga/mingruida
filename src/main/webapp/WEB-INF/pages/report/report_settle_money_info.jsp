...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr20">电话：<input  class="easyui-textbox" style="width:150px;" name="dept_mobile"  data-options="validType:['int','length[1,11]']"/></span>			
				<span class="lay_text_bor mr20">服务商名：<input  class="easyui-textbox" style="width:150px;" name="dept_name" /></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_settle_money_info.js?v=${applicationScope.v}"></c:url>'></script>
