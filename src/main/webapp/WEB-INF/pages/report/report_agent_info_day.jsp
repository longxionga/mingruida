...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr10">日期选择：<input class="easyui-datebox" name="begindate" data-options="editable:false,showSeconds:true" style="width:150px;" id="skssj"/>&nbsp;-
				<input class="easyui-datebox" name="enddate" data-options="editable:false,showSeconds:true" style="width:150px;" id="sjssj" /></span>
            ...
            <div id="total" class="total">
               	<!--<span>服务商日充值汇总：¥ ${RECHARGE_DAYCOUNT}</span>
				<span>服务商日提现汇总：¥ ${WITHDRAWALS_DAYCOUNT}</span>
				<span>服务商日盈亏汇总：¥ ${PROFIT_LOSS_DAYCOUNT}</span>
				<span>服务商日手续汇总：¥ ${COUNTER_FEE_DAYCOUNT}</span>
				<span>服务商日余额汇总：¥ ${BALANCE_DAYCOUNT}</span>
				<span>服务商日冲红汇总：¥ ${BAD_DAYCOUNT}</span>  -->
            </div>
		</div>
</div>
<script>
...
<script type="text/javascript" src='<c:url value="/static/report/report_agent_info_day.js?v=${applicationScope.v}"></c:url>'></script>
