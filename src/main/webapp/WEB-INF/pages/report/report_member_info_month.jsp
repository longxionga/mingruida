...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr10">时间选择：<input class="easyui-datebox" name="begindate" data-options="editable:false,showSeconds:false" style="width:150px;" />&nbsp;-
...
<script type="text/javascript" src='<c:url value="/static/report/report_member_info_month.js?v=${applicationScope.v}"></c:url>'></script>
