...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				<span class="lay_text_bor mr20">用户名：<input class="easyui-textbox" style="width:150px;" id="name" name="name"  data-options="validType:'length[1,20]'"/></span>
				...
				<span class="lay_text_bor mr20">充值类型：<input class="easyui-combobox" style="width:150px;" id="pay_method" name="pay_method"/></span>
				<span class="lay_text_bor mr20">充值状态：<input class="easyui-combobox" id="status" name='status' style="width:100px;" data-options="valueField:'id',textField:'text'" /></span>
				...
				<span class="lay_text_bor">
					...
					<span class="mr10"><a href="#" onclick='expRechargeInfo();' class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-redo'">导出报表</a></span>
					</c:if>
					<!-- 查询按钮放最前，刷新按钮放最后 -->
				</span>
				</form>
...
<script type="text/javascript" src='<c:url value="/static/report/report_recharge_info.js?v=${applicationScope.v}"></c:url>'></script>
