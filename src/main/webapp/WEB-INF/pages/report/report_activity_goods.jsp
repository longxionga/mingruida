    ...
    <div id="toolbar">
        <div class="pt10 pr10 pl10">
            <form id="search" method="post">
                ...
                <span class="lay_text_bor mr10">昵称： <input class="easyui-textbox" style="width: 150px;" name="nick_name" /></span>
                <span class="lay_text_bor mr10">手机号：<input class="easyui-textbox" style="width: 150px;" name="mobile" /></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_activity_goods.js?v=${applicationScope.v}"></c:url>'></script>
