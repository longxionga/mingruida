...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr20">订单号：<input class="easyui-textbox" style="width:280px;" name="order_id"/></span>				
				...
				<span class="lay_text_bor mr20">订单状态：<input class="easyui-combobox"  id="state_type"  name="state_type" data-options="" style="width:150px;" /></span>
				<span class="lay_text_bor mr10">日期选择：<input class="easyui-datetimebox" name="begindate" data-options="editable:false,showSeconds:true" style="width:180px;" id="skssj" />&nbsp;-
...
<script type="text/javascript" src='<c:url value="/static/report/report_chargeback_info.js?v=${applicationScope.v}"></c:url>'></script>
