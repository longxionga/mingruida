		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor">
					...
					<span class="mr10"><a href="#" onclick='expEnsureInfo();' class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-redo'">导出报表</a></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_rechargeensure_info.js?v=${applicationScope.v}"></c:url>'></script>
