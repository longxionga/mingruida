...
<div style="display: none">
		...
		<div id="toolbar">		
			...
			<form id="search" method="post">				
				...
				<span class="lay_text_bor mr10">服务商单位：<input  class="easyui-combobox" style="width:150px;" id="settle_id" name="settle_id" data-options="valueField:'id',textField:'text'"/></span>
...
<script type="text/javascript" src='<c:url value="/static/report/report_settle_month.js?v=${applicationScope.v}"></c:url>'></script>
