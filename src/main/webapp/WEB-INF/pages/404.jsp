...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
    	.main-error-style-403{ margin:120px auto 0; width:396px; height:69px; background: url('${pageContext.request.contextPath}/static/images/error/404_.png') no-repeat;}
