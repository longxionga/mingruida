	...
	<div style="display: none">
		...
		<div id="toolbar">
			<div class="pt10 pr10 pl10">
				...
				<span class="lay_text_bor mr20">位属服务商：<input  class="easyui-combobox" style="width:150px;" id="settle_id" name="s_id" data-options="valueField:'id',textField:'text'"/></span>
				<span class="lay_text_bor mr20">位属代理商：<input class="easyui-combobox" id="agent_id" name="a_id" style="width:150px;" data-options="valueField:'id',textField:'text'"/></span>
		...
		<div id="update" class="easyui-window" title="" style="padding:15px 13px 15px 30px;width:588px;height:381px;" data-options="iconCls:'icon-add',modal:!0,collapsible:!1,minimizable:!1,maximizable:!1,closed:!0">
			<form id="updateform" method="post" autocomplete="off" action="updDeptProrateTemp" data-autoform="
				...
				">
				  <table class="tables">
				  	...
				  	<tr>
				  		<td>渠  道  部：<span id="ch_name">运营中心</span></td>
				  	...
				  	<tr>
				  		<td>经  纪  人：<span id="broker_name">经纪人</span></td>
				  		<td><input class="easyui-textbox" style="width:150px;"  id="b_allot" name="b_allot" data-options="required:true,validType:['percentage','int']"></td>
				  	</tr>
					<tr>
...
<script type="text/javascript" src='<c:url value="/static/sys/sys_dept_prorate_temp.js?v=${applicationScope.v}"></c:url>'></script>
